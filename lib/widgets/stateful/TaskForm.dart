  ...
  void _createTask() async{
    if (_formKey.currentState.validate() &&
      ...
      MyTask task = MyTask(this._id, this._taskName, this._description, this._date,
          this._time, audioDescription, timestamp,currentUser.token,
          Utils.TO_DO,currentUser.id,idsList,urlList,Utils.getCurrentProject(context).id,Utils.getCurrentProject(context).name);
